...
object HC {
  ...
  final val PHC_ANNOUNCE_GOSSIP_TAG = 65515
  final val PHC_ANNOUNCE_SYNC_TAG = 65513
  final val PHC_UPDATE_GOSSIP_TAG = 65511
  final val PHC_UPDATE_SYNC_TAG = 65509

  final val HC_UPDATE_ADD_HTLC_TAG = 65507
  final val HC_UPDATE_FULFILL_HTLC_TAG = 65505
  final val HC_UPDATE_FAIL_HTLC_TAG = 65503
  final val HC_UPDATE_FAIL_MALFORMED_HTLC_TAG = 65501
